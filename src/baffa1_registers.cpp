...
//
	BAFFA1_BYTE inMSWh_ZF = refresh_MSWh_ZF(controller_bus, alu_bus);
	BAFFA1_BYTE inMSWh_CF = refresh_MSWh_CF(controller_bus, alu_bus);
	BAFFA1_BYTE inMSWh_SF = refresh_MSWh_SF(controller_bus, alu_bus);
	BAFFA1_BYTE inMSWh_OF = refresh_MSWh_OF(controller_bus, alu_bus, u_sf);
