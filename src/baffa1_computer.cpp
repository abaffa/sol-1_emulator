...
void BAFFA1_COMPUTER::clock_high() {
	...
	////////////////////////////////////////////////////////////////////////////
	// MICROCODE
	this->cpu.microcode.sequencer_update(this->cpu.registers.MSWl.value());		// Sets Microcode
	...
	*/
	...
	while (1) {
		...
		*/
		...
		if (this->cpu.microcode.controller_bus.mux == 0x02) {
		...
		*/
		...
		if (this->cpu.microcode.controller_bus.panel_step == 1 && this->cpu.microcode.controller_bus.mux == 0x02) {
			this->_hw_tty.print("###########################################\n");
