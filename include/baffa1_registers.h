...
public:
	...
	void refresh(struct baffa1_controller_bus *controller_bus, BAFFA1_ALU_BUS& alu_bus, BAFFA1_BYTE data_bus, BAFFA1_BYTE u_sf, BAFFA1_CONFIG& config, FILE *fa);
	void refresh_reg_flags(struct baffa1_controller_bus *controller_bus, BAFFA1_ALU_BUS& alu_bus, BAFFA1_BYTE u_sf);


private:

	BAFFA1_BYTE refresh_MSWh_ZF(struct baffa1_controller_bus *controller_bus, BAFFA1_ALU_BUS& alu_bus);
	BAFFA1_BYTE refresh_MSWh_CF(struct baffa1_controller_bus *controller_bus, BAFFA1_ALU_BUS& alu_bus);
	BAFFA1_BYTE refresh_MSWh_SF(struct baffa1_controller_bus *controller_bus, BAFFA1_ALU_BUS& alu_bus);
	BAFFA1_BYTE refresh_MSWh_OF(struct baffa1_controller_bus *controller_bus, BAFFA1_ALU_BUS& alu_bus, BAFFA1_BYTE u_sf);
