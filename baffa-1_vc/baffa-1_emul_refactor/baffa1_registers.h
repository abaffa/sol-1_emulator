...
//	BAFFA1_REGISTER_8BIT PTB;  // PTB (8bit) = Page table base
	...
	void process(BAFFA1_DATA_BUS &data_bus, BAFFA1_CONTROLLER_BUS &controller_bus, BAFFA1_ALU_BUS &alu_bus, BAFFA1_BYTE MSWl_value, BAFFA1_BYTE u_sf, BAFFA1_CONFIG &cpu_config);
	...
	BAFFA1_BYTE w_bus_refresh(BAFFA1_BYTE bus_tristate, BAFFA1_BYTE panel_regsel, BAFFA1_BYTE alu_a_src, BAFFA1_BYTE display_reg_load,
		BAFFA1_BYTE int_vector, BAFFA1_BYTE int_masks, BAFFA1_BYTE int_status, BAFFA1_CONFIG &cpu_config);

	BAFFA1_BYTE k_bus_refresh(BAFFA1_BYTE alu_b_src);

	void debugger(BAFFA1_CONFIG &cpu_config, HW_TTY &_hw_tty);
	void display_registers(BAFFA1_CONFIG &cpu_config, HW_TTY &_hw_tty);
};
#endif