...
public:
	...
	//
	// Verificar a real necessidade de ter isso no barramento ou usar a função
	...
	BAFFA1_BYTE cpu_reset = 0; //controller, alu, memory
	BAFFA1_BYTE cpu_restart = 0;


	void init();
	void reset();

	BAFFA1_BYTE bus_tristate(BAFFA1_BYTE MSWl_value);

	BAFFA1_BYTE bus_rd(BAFFA1_BYTE MSWl_value, BAFFA1_BYTE rd, BAFFA1_BYTE panel_rd);
	BAFFA1_BYTE bus_wr(BAFFA1_BYTE MSWl_value, BAFFA1_BYTE wr, BAFFA1_BYTE panel_wr);
	BAFFA1_BYTE bus_mem_io(BAFFA1_BYTE MSWl_value, BAFFA1_BYTE mem_io, BAFFA1_BYTE panel_mem_io);
};
