...
public:
	...
	void sequencer_start(BAFFA1_BYTE final_condition, BAFFA1_DATA_BUS& databus, BAFFA1_CONTROLLER_BUS& controller_bus);
	void sequencer_end(BAFFA1_CONTROLLER_BUS& controller_bus);

	void debugger(BAFFA1_BYTE final_condition, BAFFA1_CONTROLLER_BUS& controller_bus, BAFFA1_CONFIG &cpu_config, HW_TTY &_hw_tty);
...
private:
	...
	void load_microcode_from_rom(BAFFA1_DWORD addr, BAFFA1_CONTROLLER_BUS& controller_bus); //Clock down
};
#endif
